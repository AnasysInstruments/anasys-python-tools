...
class AnasysDoc(anasysfile.AnasysElement):
    ...
    def __init__(self, ftree):
        self._skip_on_write = []
        self._iterable_write = {'HeightMaps': 'Label', #a/0 9/7/17 values aren't used for anything
                                'RenderedSpectra': 'ID',
                                'SpectraChannelViews': 'Label',
                            #    'AFMUIChannels': None,
                                'AFMChannelViews': 'Label',
                                'Groups': 'Name',
                                'AFMSettings': 'ID'}
        ...
        self._should_be_dict = {#'HeightMaps': 'Name',
                                # 'RenderedSpectra': 'Label',
                                # 'Backgrounds': 'ID',
                                'SpectraChannelViews': 'Label',
                                'AFMChannelViews': 'Label',
                                'Groups': 'Name',
        ...
        #                       'AFMSettings': self._etree_to_anasys}
